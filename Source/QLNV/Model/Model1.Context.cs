...
namespace QLNV.Model
{
    ...
    public partial class QLPCNhanVienEntities1 : DbContext
    {
        public QLPCNhanVienEntities1()
            : base("name=QLPCNhanVienEntities1")
        {
        }
        ...
        public virtual DbSet<DotCongViec> DotCongViec { get; set; }
